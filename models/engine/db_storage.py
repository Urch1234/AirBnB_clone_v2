...
class DBStorage:
    ...
    def all(self, cls=None):
        """
        Query on the current database session all objects of a class.

        Args:
            cls (type): The class type to query. If None, queries all types.

        Returns:
            dict: Dictionary of queried objects.
        """
        dct = {}
        if cls is None:
    ...
    def delete(self, obj=None):
        ...
        Args:
            obj (BaseModel): The object to delete. If None, does nothing.
        """
        if obj is not None:
